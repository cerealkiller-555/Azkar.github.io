window.AZKAR_DATA = {
    defaultCustomDuas: [
        ...
        "اللهم اني اسألك الثبات في الأمر والعزيمة على الرشد، وأسألك شكر نعمتك وحسن عبادتك، وأسألك قلبا سليما ولسانا صادقا، وأسألك من خير ما تعلم وأعوذ بك من شر ما تعلم، وأنت علام الغيوب"
    ],
    tabs: [
    ...
    azkar: {
        morning: [
            ...
            },
            {
                ...
                source: "ابو داود والترمذي",
                sourceEn: "Abu Dawud and al-Tirmidhi",
                grade: "حسن",
                gradeEn: "Hasan"
            ...
            },
            {
                id: 7,
                title: "سيد الاستغفار",
                text: "اللَّهُمَّ أَنْتَ رَبِّي لَا إِلَهَ إِلاَّ أَنْتَ، خَلَقْتَنِي وَأَنَا عَبْدُكَ، وَأَنَا عَلَى عَهْدِكَ وَوَعْدِكَ مَا اسْتَطَعْتُ، أَعُوذُ بِكَ مِنْ شَرِّ مَا صَنَعْتُ، أَبُوءُ لَكَ بِنِعْمَتِكَ عَلَيَّ، وَأَبُوءُ بِذَنْبِي فَاغْفِرْ لِي فَإِنَّهُ لَا يَغْفِرُ الذُّنُوبَ إِلَّا أَنْتَ",
                count: 1,
            ...
            },
            {
                ...
                source: "ابو داود والنسائي",
                sourceEn: "Abu Dawood, Al-Nasa'i",
                grade: "إسناده حسن",
                gradeEn: "Hasan"
            },
            {
            ...
            },
            {
                ...
                source: "ابو داود واحمد والنسائي",
                sourceEn: "Abu Dawood, Ahmad, Al-Nasa'i",
                grade: "إسناده حسن",
                gradeEn: "Hasan"
            },
            {
                ...
                count: 1,
                source: "ابو داود وابن ماجه",
                sourceEn: "Abu Dawood, Ibn Majah",
                grade: "صحيح",
                gradeEn: "Sahih",
                meaning: "العافية: هي حفظ الله للعبد من الأمراض والبلايا والشرور، سواء في الدين أو الدنيا أو الأهل أو المال. وفي الدين تعني حفظه من كل ما يفسده، وفي الدنيا من كل ما يضره، وفي الأهل من المصائب والأسقام، وفي المال من الضياع والآفات. والعورة: كل ما يستحي الإنسان من ظهوره أو كل عيب وخلل، والمراد بها هنا كل نقص أو فساد. وآمن روعاتي: أي اجعلني في أمان من الفزع والخوف. ومن بين يدي ومن خلفي وعن يميني وعن شمالي ومن فوقي: طلب للحفظ الإلهي من جميع الجهات من كل شر ومكروه، وخاصة من الشيطان والمهالك التي تأتي من الغفلة والبلاء"
            },
            {
                id: 12,
                ...
                count: 1,
                source: "الترمذي وابو داود",
                sourceEn: "Abu Dawood, Al-Tirmidhi",
            ...
            },
            {
                ...
                count: 3,
                benefit: "من قالها ثلاث مرات حين يصبح أو يمسي لم تصبه فجأة بلاء حتى يصبح أو يمسي",
                source: "ابو داود",
                sourceEn: "Abu Dawood",
                grade: "صحيح",
                gradeEn: "Sahih",
            ...
            },
            {
                ...
                benefitEn: "The Prophet ﷺ urged people to repent to Allah, and he himself used to repent to Him 100 times a day, showing the virtue of frequent repentance",
                source: "مسلم",
                sourceEn: "Sahih Muslim",
                grade: "صحيح",
                gradeEn: "Sahih"
        ...
        evening: [
            ...
            {
                id: 5,
                text: "أمسَينا وأمسى الْمُلْكُ لِلَّهِ ، وَالْحَمْدُ لِلَّهِ، لاَ إِلَهَ إلاَّ اللَّهُ وَحْدَهُ لاَ شَرِيكَ لَهُ، لَهُ الْمُلْكُ وَلَهُ الْحَمْدُ وَهُوَ عَلَى كُلِّ شَيْءٍ قَدِيرٌ، رَبِّ أَسْأَلُكَ خَيْرَ مَا في هذه الليلة وَخَيرَ مَا بَعْدَهُا ، وَأَعُوذُ بِكَ مِنْ شَرِّ مَا فِي هذه اليلة وَشَرِّ مَا بَعْدَهُا، رَبِّ أَعُوذُ بِكَ مِنَ الْكَسَلِ وَسُوءِ الْكِبَرِ، رَبِّ أَعُوذُ بِكَ مِنْ عَذَابٍ فِي النَّارِ وَعَذَابٍ فِي الْقَبْرِ",
                count: 1,
            ...
            },
            {
                ...
                meaning: "بك أصبحنا: أي بنعمتك وحفظك وفضلك دخلنا في الصباح. وبك نحيا: أي نستجير ونستعين بك في جميع الأوقات والأحوال. وإليك المصير: أي المرجع.",
                meaningEn: "By You we have reached the evening and by You we have reached the morning, by You we live and by You we die, and to You is the return.",
                source: " صحيح الترمذي",
                sourceEn: "Sahih Al-Tirmidhi",
                grade: "حسن صحيح",
                gradeEn: "Hasan Sahih"
            ...
            {
                id: 8,
                text: "اللَّهُمَّ إنِّي أمسَيتُ أُشْهِدُكَ، وأُشْهِدُ حَمَلَةَ عَرْشِكَ، ومَلائِكَتَكَ، وجَمِيعَ خَلْقِكَ، أَنَّكَ أَنْتَ اللهُ لَا إِلَهَ إِلَّا أَنْتَ وَحْدَكَ لَا شَرِيكَ لَكَ، وَأَنَّ مُحَمَّدًا عَبْدُكَ وَرَسُولُكَ",
                count: 4,
                benefit: "من قال هذا الدعاء حين يصبح أو يمسي أربع مرات أعتقه الله من النار",
                benefitEn: "Whoever says this supplication four times in the morning or evening will be freed from the Fire",
                source: "ابو داود والنسائي",
            ...
            },
            {
                ...
                count: 1,
                meaning: "العافية: هي حفظ الله للعبد من الأمراض والبلايا والشرور، سواء في الدين أو الدنيا أو الأهل أو المال. وفي الدين تعني حفظه من كل ما يفسده، وفي الدنيا من كل ما يضره، وفي الأهل من المصائب والأسقام، وفي المال من الضياع والآفات. والعورة: كل ما يستحي الإنسان من ظهوره أو كل عيب وخلل، والمراد بها هنا كل نقص أو فساد. وآمن روعاتي: أي اجعلني في أمان من الفزع والخوف. ومن بين يدي ومن خلفي وعن يميني وعن شمالي ومن فوقي: طلب للحفظ الإلهي من جميع الجهات من كل شر ومكروه، وخاصة من الشيطان والمهالك التي تأتي من الغفلة والبلاء",
                meaningEn: "Al-Afiyah: It is the protection of Allah for the servant from diseases, calamities, and evils, whether in religion, the world, family, or wealth. In religion, it means protecting him from everything that corrupts it, in the world from everything that harms him, in the family from calamities and diseases, and in wealth from loss and afflictions. And Al-Awrah: Everything that a person is shy to reveal or any defect or flaw, and what is meant here is every deficiency or corruption. And secure my fears: meaning, make me safe from panic and fear. And from before me and from behind me and from my right and from my left and from above me: a request for divine protection from all directions from all evil and disliked things, especially from Satan and the dangers that come from negligence and tribulation",
                source: "ابو داود وابن ماجه",
                sourceEn: "Abu Dawood, Ibn Majah",
                grade: "صحيح",
                gradeEn: "Sahih",
            },
            {
                ...
                sourceEn: "Abu Dawood, Al-Tirmidhi",
                meaning: "قوله: اللهم عالم الغيب والشهادة، أي يا من يعلم كل ما غاب عن الخلق وما شهدوه. فاطر السماوات والأرض أي خالقهما ومبدعهما على غير مثال سابق. رب كل شيء ومليكه أي مالك كل شيء ومتصرف فيه. أشهد أن لا إله إلا أنت أي أقر وأعترف بوحدانيتك. أعوذ بك من شر نفسي أي أستجير بك من شر ما تميل إليه النفس من السوء. ومن شر الشيطان وشركه أي من وساوسه وإضلاله أو حبائله ومصائده. وأن أقترف على نفسي سوءًا أي أن أكتسب ذنبًا أو أوقع نفسي في المعصية. أو أجره إلى مسلم أي أو أتسبب في إيصال الأذى أو الشر إلى مسلم",
                meaningEn: "O Allah, Knower of the unseen and the seen, Creator of the heavens and the earth, Lord of all and Sovereign of all. I bear witness that there is no god but You. I seek refuge in You from the evil of my soul, from the evil of Satan and his shirk, and from bringing evil upon myself or bringing it to a Muslim.",
                grade: "صحيح",
                gradeEn: "Sahih"
            },
            {
            ...
            },
            {
                ...
                text: "أمسَينا عَلَى فِطْرَةِ الْإِسْلَامِ، وَعَلَى كَلِمَةِ الْإِخْلَاصِ، وَعَلَى دِينِ نَبِيِّنَا مُحَمَّدٍ ﷺ، وَعَلَى مِلَّةِ أَبِينَا إِبْرَاهِيمَ حَنِيفًا مُسْلِمًا وَمَا كَانَ مِنَ الْمُشْرِكِينَ",

                count: 1,

                meaning: "على فطرة الإسلام أي الدين الذي فطر الله الناس عليه، وعلى كلمة الإخلاص أي شهادة التوحيد، وعلى دين نبينا محمد أي اتباع شريعته، وعلى ملة إبراهيم حنيفًا أي مائلًا إلى الحق مستقيماً عليه",

                meaningEn: "We have reached the evening upon the Fitrah (natural disposition) of Islam, upon the word of sincerity, upon the religion of our Prophet Muhammad (peace be upon him), and upon the creed of our father Abraham, who was a monotheist and a Muslim, and was not among the polytheists.",
                source: "مسند أحمد",
                sourceEn: "Musnad Ahmad",
